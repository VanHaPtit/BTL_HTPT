...
* **Cập nhật trạng thái hiện diện (Presence Update):** Cập nhật cursor, trạng thái hiện diện, và các thông tin presence khác của người dùng qua kênh `/app/documents/{id}/presence.update`.
